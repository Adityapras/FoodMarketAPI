                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4 text-center">
                                    ...
                                    <form action="{{ route('users.destroy', $item->id) }}" method="POST" class="inline-block">
                                        ...
                                        <button type="submit" class="inline-block bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 mx-2 rounded">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="border text-center">data not found</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
