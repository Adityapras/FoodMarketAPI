      ...
      <ul class="nav top-menu">
          ...
          <li class="dropdown">
              ...
              <ul class="dropdown-menu extended tasks-bar">
                  ...
                  <li class="external">
                      <a href="{{url('template')}}/#">See All Tasks</a>
                  </li>
              </ul>
          </li>
          <!-- settings end -->
          ...
          <li id="header_inbox_bar" class="dropdown">
              ...
              <ul class="dropdown-menu extended inbox">
                  ...
                  <li>
                      <a href="{{url('template')}}/#">
                          <span class="photo"><img alt="avatar" src="{{url('template')}}/img/avatar-mini.jpg"></span>
                          <span class="subject">
                  ...
                  <li>
                      <a href="{{url('template')}}/#">
                          <span class="photo"><img alt="avatar" src="{{url('template')}}/img/avatar-mini2.jpg"></span>
                          <span class="subject">
                  ...
                  <li>
                      <a href="{{url('template')}}/#">
                          <span class="photo"><img alt="avatar" src="{{url('template')}}/img/avatar-mini3.jpg"></span>
                          <span class="subject">
                  ...
                  <li>
                      <a href="{{url('template')}}/#">
                          <span class="photo"><img alt="avatar" src="{{url('template')}}/img/avatar-mini4.jpg"></span>
                          <span class="subject">
                  ...
                  <li>
                      <a href="{{url('template')}}/#">See all messages</a>
                  </li>
              </ul>
          </li>
          <!-- inbox dropdown end -->
          ...
          <li id="header_notification_bar" class="dropdown">
              ...
              <ul class="dropdown-menu extended notification">
                  ...
                  <li>
                      <a href="{{url('template')}}/#">See all notifications</a>
                  </li>
              </ul>
          </li>
      ...
      <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
              ...
              <ul class="dropdown-menu extended logout dropdown-menu-right">
                  ...
                  <li><a href="{{url('template')}}/login.html"><i class="fa fa-key"></i> Log Out</a></li>
              </ul>
          </li>
